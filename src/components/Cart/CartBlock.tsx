...
import { clearProducts } from '../../store/cartSlice';

const CartBlock = () => {
    const { items, countProducts, totalPrice } = useAppSelector(s => s.cart)
        ...
        <div className="cart">
            <div className="cart__top">
                <h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Корзина</h2>
                <div onClick={() => dispatch(clearProducts())} className="cart__clear">
            ...
            <div className="content__items cart__items">
                {items.map((item, i) => <CartItem key={i} pizza={item} />)}
            </div>
            <div className="cart__bottom">
                <div className="cart__bottom-details">
                    <span> Всего пицц: <b>{countProducts} шт.</b> </span>
